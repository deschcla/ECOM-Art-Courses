...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ecom.art_courses.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ecom.art_courses.security.DomainUserDetailsService", "createSpringSecurityUser");
