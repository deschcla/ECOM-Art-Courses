...
describe('SousCategorie routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return ISousCategorie returned by find', () => {
      // GIVEN
      ...
      expect(resultSousCategorie).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultSousCategorie).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ISousCategorie>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
      ...
      // THEN
      expect(service.find).toBeCalledWith(123);
      expect(resultSousCategorie).toEqual(undefined);
