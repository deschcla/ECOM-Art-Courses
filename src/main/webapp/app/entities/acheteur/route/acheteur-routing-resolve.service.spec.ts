...
describe('Acheteur routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IAcheteur returned by find', () => {
      // GIVEN
      ...
      expect(resultAcheteur).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultAcheteur).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IAcheteur>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
      ...
      // THEN
      expect(service.find).toBeCalledWith(123);
      expect(resultAcheteur).toEqual(undefined);
